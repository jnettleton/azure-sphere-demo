...
static IOTHUB_DEVICE_CLIENT_LL_HANDLE iothubClientHandle;

static Iothub_Connection_StatusCallbackType connectionStatusCallback = NULL;

static bool SetUpAzureIoTHubClientWithDaa(void);
static bool Iothub_IsReadyToConnect(void);
    ...
    ExitCode_CallbackType failureCallback, const char* modelId, void* context)
{
    ...
    Iothub_Connection_Config* config = context;
